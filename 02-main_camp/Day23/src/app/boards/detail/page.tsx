...
const BoardsDetail = () => {
    console.log(styles.BoardsDetail)
    return (
        <div className={styles.BoardsDetail_root}>
            <header className={styles.BoardsDetail_header}>살어리 살어리랏다 쳥산(靑山)애 살어리랏다멀위랑 ᄃᆞ래랑 먹고 쳥산(靑山)애 살어리랏다얄리얄리 얄랑셩 얄라리 얄라</header>
            <div className={styles.BoardsDetail_userForm_and_sideButton}>
                <div className={styles.BoardsDetail_userForm}>
                    <div className={styles.profileName}><img className={styles.profileImg} src="/assets/profile.png"/>홍길동</div>
