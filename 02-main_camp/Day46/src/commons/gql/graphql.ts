...
export type FetchUserLoggedInQuery = { __typename?: 'Query', fetchUserLoggedIn: { __typename?: 'User', _id: string, name: string, userPoint?: { __typename?: 'UserPoint', amount: number } | null } };
