...
const TestComp = () => {
    ...
    return (
        <>
            <header>
                <p style={{fontSize: "20px", padding: "20px 0px"}}>살어리 살어리랏다 쳥산(靑山)애 살어리랏다멀위랑 ᄃᆞ래랑 먹고 쳥산(靑山)애 살어리랏다얄리얄리 얄랑셩 얄라리 얄라</p>
            ...
            <div class="icon" style={{display: "flex", justifyContent: "flex-end"}}>
                <img alt="link" src="/asset/link.svg"/>
                <img alt="location" src="/asset/location.svg"/>
            </div>
            <div class="section">
                <img alt="mainImg" src="/asset/bg01.png"/>
                <p style={{whiteSpace: "pre-wrap", width: "400px", margin: "20px 0px"}}>
                    <Content />
                </p>
                <div class="bg" style={{backgroundColor: "#F2F2F2", display: "flex" ,justifyContent: "center", alignItems: "center",height: "400px"}}>
                ...
                <div style={{display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "60px", gap: "20px"}}>
                    <div style={{display: "flex", alignItems: "center", padding: "12px", border: "1px solid #222", borderRadius: "8px"}}>
