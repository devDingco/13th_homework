...
const JS_복사하기기능 = () => {
  const 내용 = document.getElementById("HTML_일기내용").innerText
...
document.querySelectorAll("HTML_복사").forEach(button => {
    button.addEventListener('click', function() {
      console.log(toast)
        var toast = document.getElementById('토스트메시지');
        
        // 기존 위치 클래스를 제거
        toast.className = '토스트페시지';
