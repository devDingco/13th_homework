...
import { ButtonSoftFull } from "@/commons/ui/25-03-button-base-typescript-generic-1";
import { InputSoftFull } from "@/commons/ui/25-03-input-base-typescript-generic-1";
  ...
  return (
    <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(onSubmit)}>
        ...
        {/* 내용(컴포넌트):<InputSoftFull<ISchema> type="text" keyname="contents" /> */}
        <div style={{ color: "red" }}>
