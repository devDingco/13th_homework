 ...
 */
export function graphql(
	source: 'mutation CreateBoard($createBoardInput: CreateBoardInput!) {\n  createBoard(createBoardInput: $createBoardInput) {\n    author\n    title\n    content\n    imageUrl\n    youtubeUrl\n    boardAddressOutput {\n      zoneCode\n      address\n      detailAddress\n    }\n    createdAt\n  }\n}',
): (typeof documents)['mutation CreateBoard($createBoardInput: CreateBoardInput!) {\n  createBoard(createBoardInput: $createBoardInput) {\n    author\n    title\n    content\n    imageUrl\n    youtubeUrl\n    boardAddressOutput {\n      zoneCode\n      address\n      detailAddress\n    }\n    createdAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: 'mutation CreateBoardComment($boardId: Int!, $createBoardComment: CreateBoardCommentInput!) {\n  createBoardComment(boardId: $boardId, createBoardComment: $createBoardComment) {\n    author\n    content\n    rating\n    parentId\n    _id\n    createdAt\n    replies {\n      author\n      content\n      createdAt\n    }\n  }\n}',
 ...
 */
export function graphql(
	source: 'mutation UpdateBoard($boardId: Int!, $updateBoardInput: UpdateBoardInput!) {\n  updateBoard(boardId: $boardId, updateBoardInput: $updateBoardInput) {\n    author\n    title\n    content\n    imageUrl\n    youtubeUrl\n    boardAddressOutput {\n      zoneCode\n      address\n      detailAddress\n    }\n    createdAt\n  }\n}',
): (typeof documents)['mutation UpdateBoard($boardId: Int!, $updateBoardInput: UpdateBoardInput!) {\n  updateBoard(boardId: $boardId, updateBoardInput: $updateBoardInput) {\n    author\n    title\n    content\n    imageUrl\n    youtubeUrl\n    boardAddressOutput {\n      zoneCode\n      address\n      detailAddress\n    }\n    createdAt\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: 'mutation UpdateBoardComment($boardId: Int!, $updateBoardComment: UpdateBoardCommentInput!, $commentId: String!) {\n  updateBoardComment(\n    boardId: $boardId\n    updateBoardComment: $updateBoardComment\n    commentId: $commentId\n  ) {\n    author\n    content\n    rating\n    parentId\n    _id\n    createdAt\n    replies {\n      author\n      content\n      createdAt\n    }\n  }\n}',
): (typeof documents)['mutation UpdateBoardComment($boardId: Int!, $updateBoardComment: UpdateBoardCommentInput!, $commentId: String!) {\n  updateBoardComment(\n    boardId: $boardId\n    updateBoardComment: $updateBoardComment\n    commentId: $commentId\n  ) {\n    author\n    content\n    rating\n    parentId\n    _id\n    createdAt\n    replies {\n      author\n      content\n      createdAt\n    }\n  }\n}'];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
	source: 'query GetBoardComment($boardId: Int!, $page: Int) {\n  getBoardComment(boardId: $boardId, page: $page) {\n    author\n    content\n    rating\n    parentId\n    _id\n    createdAt\n    replies {\n      author\n      content\n      createdAt\n    }\n  }\n}',
 ...
 */
export function graphql(
	source: 'query GetBoards($page: Int, $take: Int) {\n  getBoards(page: $page, take: $take) {\n    result {\n      author\n      title\n      boardId\n      createdAt\n    }\n    totalCount\n  }\n}',
