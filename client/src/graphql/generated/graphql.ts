...
export type GetBoardsQuery = { __typename?: 'Query', getBoards: Array<{ __typename?: 'BoardResponseDto', author: string, title: string, content: string, boardId: number, createdAt: any, updatedAt: any }> };
