        ...
        <div className='flex w-[1280px] flex-col items-start gap-6'>
          ...
          <div className='flex items-center justify-between gap-[54px] self-stretch'>
            <div className='flex items-center gap-1'>
              <Image width={0} height={0} src='/profile_image.png' alt='프로필이미지' />
              <div>홍길동</div>
            </div>
            <div className='text-[#818181] font-[Pretendard] text-[14px] font-normal leading-[20px]'>2024.11.11</div>
          </div>
          ...
          <div className='gap-6 flex flex-col'>
            ...
            <div className='flex justify-center items-center gap-6 self-stretch'>
              <div className='flex flex-col items-center justify-center gap-1'>
                ...
                <div className='text-[#5f5f5f] font-[Pretendard] text-[14px] font-normal leading-[20px]'>24</div>
              </div>
              <div className='flex flex-col items-center justify-center gap-1'>
                <Image width={0} height={0} src='/good.png' alt='좋아요' />
                <div className='text-[#f66a6a] font-[Pretendard] text-[14px] font-normal leading-[20px]'>12</div>
              </div>
            </div>
            <div className='flex justify-center items-center gap-6 self-stretch'>
              <button className='flex h-[40px] py-2 px-3 items-center gap-2 rounded-[8px] border border-black bg-white'>
                <Image width={0} height={0} alt='목록아이콘' src='/hamberger.png' />
                <div>목록으로</div>
              </button>
              <button className='flex h-[40px] py-2 px-3 items-center gap-2 rounded-[8px] border border-black bg-white'>
                <Image width={0} height={0} alt='수정아이콘' src='/pencil.png' />
                <div>수정하기</div>
              </button>
            </div>
          </div>
