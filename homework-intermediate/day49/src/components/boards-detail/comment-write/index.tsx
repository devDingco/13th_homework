...
export default function CommentWrite(props: CommentWriteProps) {
	...
	return (
		<div className="flex w-full max-w-7xl flex-col gap-6">
			...
			<div className="flex max-w-screen-sm gap-4">
			...
			<div>
				<textarea
					className="h-36 w-full resize-none rounded-lg border-2 p-4"
					name="comment"
			...
			<div className="flex justify-end gap-4">
				{props.isEdit && (
					<button
						className="rounded-lg border-2 bg-black p-4 text-white"
