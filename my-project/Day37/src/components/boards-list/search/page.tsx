    ...
    <div className="flex flex-col gap-6 w-[1280px] mx-auto mb-10">
      ...
      <div className="flex gap-2 min-w-[640px] w-full">
        <div className="flex gap-4 w-full">
          ...
          <div className="h-[48px] w-[64px] py-3 px-4 bg-[#000000] rounded-lg text-[#ffffff] font-semibold text-[16px] leading-6 text-center">
            검색
          </div>
        </div>
        <div className="flex py-3 px-4 gap-2 rounded-lg h-12 bg-[#2974e5] ">
