  ...
  return (
    <>
      <div className="전체박스">
        ...
        <div className="헤더전체박스">
          <div className="윗줄전체박스">
            <div className="홍길동박스">
        ...
        <div className="영상사진박스">
          <img src="/img/Frame.svg" width="822px" alt="" />
        </div>
        <div className="푸터전체박스">
          <div className="하트전체박스">
            <img className="왼쪽하트" src="/img/Vector.svg" alt="" />
            <img className="오른쪽하트" src="/img/good.svg" alt="" />
          </div>
          <div className="숫자박스">
            <div className="왼쪽24">24</div>
            <div className="오른쪽12">12</div>
          </div>
        </div>
        <div className="푸터2전체박스">
          <button>
