...
export type FetchPointTransactionsQuery = { __typename?: 'Query', fetchPointTransactions: Array<{ __typename?: 'PointTransaction', _id: string, impUid?: string | null, amount: number, balance: number, status: string, statusDetail: string, createdAt: any, updatedAt: any, deletedAt?: any | null }> };
