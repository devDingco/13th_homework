...
const BoardsNew = () => {
  ...
  // input state
  const [inputs, setInputs] = useState({ user: '', password: '', title: '', content: '' })
  // error state
    ...
    <div className="post-page">
      ...
      <div className="post-main">
        ...
        <div className="input-group">
          ...
          <textarea type="text" className="content-input-box" name="content" placeholder="내용을 입력해 주세요." onChange={onChangeInput} value={inputs.content}></textarea>
