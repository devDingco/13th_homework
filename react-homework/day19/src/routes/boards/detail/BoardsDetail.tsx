    ...
    <div className='post-detail-page'>
      ...
      <div className='info-box'>
        ...
        <div className='info-user-box'>
          <div className='info-user'>
            <img className='user-profile' src='/images/profile.png' alt='profile-image'/>
        ...
        <div className="link-location-btn-group">
          <button className='link-btn-box'><img src='/images/link.png' alt='link-button'/></button>
          <button className='location-btn-box'><img src='/images/location.png' alt='location-button'/></button>
        </div>
      </div>
      ...
      <div className='reaction-btn-group'>
        <div className='bad-btn-group'>
          <button className='bad-btn'><img src='/images/bad.png' alt='bad-button'/></button>
          <div className='bad-count'>10</div>
        </div>
        <div className='good-btn-group'>
          <button className='good-btn'><img src='/images/good.png' alt='good-button'/></button>
