                ...
                <div className={styles.detailMain}>
                    ...
                    <div className={styles.profile}>
                        <div className={styles.userProfile}>
                            ...
                            <Image src="/images/userIcon.png" alt="profile" className={styles.userIcon} width={0} height={0}/>
                        ...
                        <div className={styles.iconWrapper}>
                            <Image src="/images/linkIcon.png" alt="링크" className={styles.linkIcon} width={0} height={0}/>
                            <Image src="/images/mapIcon.png" alt="위치" className={styles.mapIcon} width={0} height={0}/>
                        </div>
                    </div>
...
얄리얄리 얄라셩 얄라리 얄라
                        ...
                        <article className={styles.likeCount}>
                            <div className={styles.icon}>
                                <Image src="/images/breakHeart.png" alt="삐빅" width={24} height={24} />
                                <div>0</div>
                            </div>
                            <div className={styles.icon}>
                                <Image src="/images/likeHeart.png" alt="좋다" width={24} height={24} />
                                <div>12</div>
                            </div>
                        </article>
                    </section>
