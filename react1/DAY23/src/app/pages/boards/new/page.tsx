        ...
        <legend className={styles.legend}>게시물 등록</legend>
                        <div className={styles.formControl}>
                            <div className={styles.firstLine}>
                                ...
                                {data?.fetchBoard.writer && <span>{data.fetchBoard.writer}</span>}
                                </div>
                            <div className={styles.firstLine}>
                    ...
                    <label htmlFor="title">제목</label>
                            ...
                            {data?.fetchBoard.title && <span>{data.fetchBoard.title}</span>}
                        </div>
                        <HrLine />
                ...
                <div className={styles.formContent}>
                    <label htmlFor="content">내용</label>
                            ...
                            {data?.fetchBoard.contents && <span>{data.fetchBoard.contents}</span>}
