...
export type FetchBoardsQuery = { __typename?: 'Query', fetchBoards: Array<{ __typename?: 'Board', _id: string, title: string, writer?: string | null, contents: string, createdAt: any }> };
