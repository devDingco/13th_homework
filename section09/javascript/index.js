...
const renderData = (array) => {
  ...
  <li class="panel-item">
    <a href="./detail.html?number=${index}#review">
      ...
      ${el.emotion === 'happy' ? '<img src="./assets/images/image_emotion_happy.png" alt="행복해요" />' : ''}
      ${el.emotion === 'sad' ? '<img src="./assets/images/image_emotion_sad.png" alt="슬퍼요" />' : ''}
      ${el.emotion === 'surprising' ? '<img src="./assets/images/image_emotion_surprising.png" alt="놀랐어요" />' : ''}
      ${el.emotion === 'angry' ? '<img src="./assets/images/image_emotion_angry.png" alt="화나요" />' : ''}
      ${el.emotion === 'etc' ? '<img src="./assets/images/image_emotion_etc.png" alt="기타" />' : ''}
      </div>
