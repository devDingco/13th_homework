...
export type BoardAddressOutputResolvers<ContextType = any, ParentType extends ResolversParentTypes['BoardAddressOutput'] = ResolversParentTypes['BoardAddressOutput']> = {
...
export type BoardPaginationResponseResolvers<ContextType = any, ParentType extends ResolversParentTypes['BoardPaginationResponse'] = ResolversParentTypes['BoardPaginationResponse']> = {
    result?: Resolver<Array<ResolversTypes['BoardSchema']>, ParentType, ContextType>;
    totalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
export type BoardReactionSchemaResolvers<ContextType = any, ParentType extends ResolversParentTypes['BoardReactionSchema'] = ResolversParentTypes['BoardReactionSchema']> = {
    _id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    boardId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type BoardSchemaResolvers<ContextType = any, ParentType extends ResolversParentTypes['BoardSchema'] = ResolversParentTypes['BoardSchema']> = {
    _id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    author?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    boardAddressOutput?: Resolver<Maybe<ResolversTypes['BoardAddressOutput']>, ParentType, ContextType>;
    boardId?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
    content?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
    createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
    ...
    createBoard?: Resolver<ResolversTypes['BoardSchema'], ParentType, ContextType, RequireFields<MutationCreateBoardArgs, 'createBoardInput'>>;
    createBoardComment?: Resolver<ResolversTypes['BoardCommentResponseDTO'], ParentType, ContextType, RequireFields<MutationCreateBoardCommentArgs, 'boardId' | 'createBoardComment'>>;
    deleteBoard?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteBoardArgs, 'boardId'>>;
    deleteBoardComment?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteBoardCommentArgs, 'boardId' | 'commentId'>>;
    isPasswordCorrect?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationIsPasswordCorrectArgs, 'boardId' | 'password'>>;
    updateBoard?: Resolver<ResolversTypes['BoardSchema'], ParentType, ContextType, RequireFields<MutationUpdateBoardArgs, 'boardId' | 'updateBoardInput'>>;
    updateBoardComment?: Resolver<ResolversTypes['BoardCommentResponseDTO'], ParentType, ContextType, RequireFields<MutationUpdateBoardCommentArgs, 'boardId' | 'commentId' | 'updateBoardComment'>>;
};
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
    getBoard?: Resolver<ResolversTypes['BoardSchema'], ParentType, ContextType, RequireFields<QueryGetBoardArgs, 'boardId'>>;
    getBoardComment?: Resolver<Array<ResolversTypes['BoardCommentResponseDTO']>, ParentType, ContextType, RequireFields<QueryGetBoardCommentArgs, 'boardId'>>;
    getBoardReaction?: Resolver<ResolversTypes['BoardReactionSchema'], ParentType, ContextType, RequireFields<QueryGetBoardReactionArgs, 'boardId'>>;
    getBoards?: Resolver<ResolversTypes['BoardPaginationResponse'], ParentType, ContextType, Partial<QueryGetBoardsArgs>>;
};
