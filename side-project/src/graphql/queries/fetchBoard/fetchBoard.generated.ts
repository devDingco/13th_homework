...
export type FetchBoardQuery = { __typename?: 'Query', fetchBoard: { __typename?: 'Board', _id: string, writer?: string | null, title: string, contents: string, createdAt: Date, images?: Array<string> | null, likeCount: number, dislikeCount: number, youtubeUrl?: string | null, boardAddress?: { __typename?: 'BoardAddress', _id: string, address?: string | null, zipcode?: string | null, addressDetail?: string | null } | null } };
 ...
 * });
 */
export function useFetchBoardQuery(baseOptions: Apollo.QueryHookOptions<FetchBoardQuery, FetchBoardQueryVariables> & ({ variables: FetchBoardQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useFetchBoardSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FetchBoardQuery, FetchBoardQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<FetchBoardQuery, FetchBoardQueryVariables>(FetchBoardDocument, options);
        }
...
export type FetchBoardSuspenseQueryHookResult = ReturnType<typeof useFetchBoardSuspenseQuery>;
